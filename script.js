...
function cargarCiudad () {
    ...
    $.getJSON("https://api.openweathermap.org/data/2.5/weather?lang=es&q=" + ciudad + "&appid=4e5956be057b1cbbf8e9ce57057ff406&units=metric",
    function(data) {
...
// Cuando hagamos click en el botón debemos borrar el contenido del input.
    ...
    .fail(function() {
      ...
      } // en Pledu sobra un parentesis de cierre. Esta es la solucion sugerida. Sin embargo la api retorna un objeto:
      // {
      // "cod": "404",
